...
## 3. Execute *this* very line. What happens? nothing prints
...
## 2. What will happen if you run the above print function? doesn't change because we didn't execute the commute time statement
...
##  what type of object is it? a logical (boolean?)
